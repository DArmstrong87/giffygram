import { getUsers, postCreatedUser, setDisplayCreateUser } from "../data/provider.js"
...
applicationElement.addEventListener("click",(event)=>{
        if (event.target.id === "createUser"){
            ...
            const createdUser = {
                email: applicationElement.querySelector("input[name='createEmail']").value,
                name: applicationElement.querySelector("input[name='createUserName']").value,
                password: applicationElement.querySelector("input[name='createPassword']").value
            }
